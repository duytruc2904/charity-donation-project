...
<link type="text/css" rel="stylesheet"
	href="<c:url value='/resources/static/user/assets/css/custom-bs.css' />">
<link type="text/css" rel="stylesheet"
	href="<c:url value='/resources/static/user/assets/css/jquery.fancybox.min.css' />">
<link type="text/css" rel="stylesheet"
	href="<c:url value='/resources/static/user/assets/css/bootstrap-select.min.css' /> ">
<link type="text/css" rel="stylesheet"
	href="<c:url value='/resources/static/user/assets/fonts/icomoon/style.css' /> ">
<link type="text/css" rel="stylesheet"
	href="<c:url value='/resources/static/user/assets/fonts/line-icons/style.css' /> ">
<link type="text/css" rel="stylesheet"
	href="<c:url value='/resources/static/user/assets/css/owl.carousel.min.css' /> ">
<link type="text/css" rel="stylesheet"
	href="<c:url value='/resources/static/user/assets/css/animate.min.css' /> ">

<!-- MAIN CSS -->
<link rel="stylesheet"
	href="<c:url value='/resources/static/user/assets/css/style.css' /> ">

<script
	src="<c:url value='/resources/static/user/assets/js/jquery.min.js' /> "></script>
<script
	src="<c:url value='/resources/static/user/assets/js/bootstrap.bundle.min.js' /> "></script>
<script
	src="<c:url value='/resources/static/user/assets/js/isotope.pkgd.min.js' /> "></script>
<script
	src="<c:url value='/resources/static/user/assets/js/stickyfill.min.js' /> "></script>
<script
	src="<c:url value='/resources/static/user/assets/js/jquery.fancybox.min.js' /> "></script>
<script
	src="<c:url value='/resources/static/user/assets/js/jquery.easing.1.3.js' /> "></script>

<script
	src="<c:url value='/resources/static/user/assets/js/jquery.waypoints.min.js' /> "></script>
<script
	src="<c:url value='/resources/static/user/assets/js/jquery.animateNumber.min.js' /> "></script>
<script
	src="<c:url value='/resources/static/user/assets/js/owl.carousel.min.js' /> "></script>
<script
	src="<c:url value='/resources/static/user/assets/js/bootstrap-select.min.js' /> "></script>
<script
	src="<c:url value='/resources/static/user/assets/js/custom.js' /> "></script>
...
<body id="top">
	...
	<div class="site-wrap">
					...
					<div
						...
						<div class="ml-auto">
							<a th:if="${session.user}" th:text="${session.user.fullName}"
								...
								class="btn btn-outline-white border-width-2 d-none d-lg-inline-block"></span>Post
								a Job</a> <a href="/user/logout" th:if="${session.user}"
								class="btn btn-primary border-width-2 d-none d-lg-inline-block">Log
								Out</a> <a href="/user/login" th:unless="${session.user}"
		...
		<section class="section-hero overlay inner-page bg-image"
			style="background-image: url('<c:url value='/resources/static/user/assets/images/hero_1.jpg' />');"
			id="home-section">
			<div class="container">
				<div class="row">
					<div class="col-md-7">
				...
				<div class="row">
					<div class="col-lg-6">
						...
						<div class="pt-5">
							...
							<c:forEach var="userdonation" items="${userdonations}" begin="0"
								end="1">
									...
									<th>
										<li class="comment">
											...
											<div class="comment-body">
												...
												<div class="meta" style="color: #373b3e !important;">${userdonation.date }
												</div>
												<p>${userdonation.money }VND</p>
											</div>
									</li>
									</th>
								</ul>
						...
						<div class="bg-light p-3 border rounded mb-4">
							...
							<ul class="list-unstyled pl-3 mb-0">
								...
								<li class="mb-2"><strong class="text-black">Cá
										nhân/Tổ chức:</strong> ${donation.ogzName}</li>
								...
								<div class="row">
									...
									<div class="col-12">
										<label for="addname" class="col-form-label">Họ tên:</label> <input
											...
											type="hidden" name="donationId" value="${donation.id}">
